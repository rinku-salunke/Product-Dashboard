    ...
    <div className="flex flex-col md:flex-row w-full min-h-screen bg-[#0b0b12] font-sans overflow-x-hidden text-slate-100">
      ...
      <div className="md:hidden flex items-center justify-between bg-[#0b0b12] border-b border-white/5 px-4 py-3.5 w-full shrink-0">
        <div className="flex items-center gap-2.5">
          ...
          <h1 className="text-sm font-bold text-white tracking-tight">Admin Portal</h1>
        </div>
        <button
      ...
      >
        ...
        <nav className="flex-1 px-3 py-6 overflow-y-auto">
          <div className="space-y-1">
            <Link
              ...
              className={navLinkClass("/get-all")}
            >
        ...
        <div className="p-4 border-t border-white/5 shrink-0">
          <button
            ...
            className="w-full flex items-center justify-center gap-2 px-3 py-2.5 rounded-xl text-sm font-medium text-slate-300 hover:bg-red-500/10 hover:text-red-400 transition-all duration-200 border border-white/5 hover:border-red-500/20 cursor-pointer"
          >
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="relative">
              ...
              {isDropdownOpen && (
                <>
                  ...
                  />
                  <div className="absolute right-0 mt-2 w-40 bg-[#1e1e2a] border border-white/10 rounded-xl shadow-2xl py-1 z-50">
                    <button
                      onClick={() => {
                        setIsDropdownOpen(false);
                        handleLogout();
                      }}
                      className="w-full text-left px-4 py-2 text-sm text-slate-300 hover:bg-red-500/10 hover:text-red-400 transition-colors flex items-center gap-2"
                    >
                      <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1" />
                      </svg>
